	...
	randomTMSTeam() {
		...
		let sets = {
			...
			'Ghalya': {
				...
				shiny: true,
				item: 'Leftovers',
				moves: ['psystrike', 'shadowball', 'psychic', 'recover', 'synthesis', 'roost', 'moonblast', 'bugbuzz', 'gigadrain', 'leechseed', 'spore', 'nightdaze', 'spikyshield'],
				signatureMove: 'Moongeist Beam',
				evs: {
					hp: 252,
					spd: 252,
			...
			'Ghalgeo': {
				...
				shiny: true,
				item: 'Leftovers',
				moves: ['solarblade', 'morningsun', 'sunnyday', 'psychicfangs', 'growth', 'grassyterrain', 'flareblitz', 'accelerock', 'rocktomb', 'knockoff', 'leechseed', 'spore', 'earthquake', 'spikyshield'],
			...
			'Varnava Origin': {
				...
				gender: 'M',
				item: 'Leftovers',
				moves: ['shoreup', 'outrage', 'stoneedge', 'extremespeed', 'foulplay', 'dragondance'],
				signatureMove: 'Thousand Arrows',
				evs: {
					hp: 252,
					atk: 252,
			...
			'Dalv': {
				...
				shiny: true,
				item: 'Toxic Orb',
				moves: ['banefulbunker', 'roost', 'fly', 'vcreate', 'phantomforce', 'volttackle', 'gunkshot', 'toxic'],
				signatureMove: 'Dig',
				evs: {
					hp: 252,
					def: 252,
			...
			'Crybalt Origin': {
				...
				gender: 'M',
				item: 'Life Orb',
				moves: ['cosmicpower', 'toxic', 'recover', 'swagger', 'foulplay', 'encore', 'knockoff', 'protect'],
				signatureMove: 'Night Shade',
				evs: {
					hp: 252,
					def: 252,
					spd: 252,
			...
			'Ghator Origin': {
				...
				gender: 'M',
				item: 'Leftovers',
				moves: ['psychic', 'recover', 'bugbuzz', 'gigadrain', 'meanlook', 'perishsong', 'psystrike', 'leechseed', 'spore', 'nightdaze', 'spikyshield', 'oblivionwing'],
